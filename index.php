			...
			<div class="contenedor-slider">
					<?php
						...
						if ($the_query->have_posts()):
							// Inicializa el contador y el HTML
							$contador = 0;
							$html = '';
							...
							while ($the_query->have_posts()):
								...
								$html .= '<li class="slide promo js-abrir-promo" data-imagen="' . esc_url($imagen_promocion) . '" data-texto="' . esc_attr($descripcion_promocion) . '">
									<img src="' . esc_url($imagen_promocion) . '" alt="">
									</li>';
							endwhile;
							wp_reset_postdata();

							// Si solo hay una promoción
							if ($contador == 1):
								// No es necesario un slider
								echo '<div class="promo-unica">' . $html . '</div>';
							else:
								// Si hay más de una promoción, usar flexslider
								?>
		...
		<div class="pantalla-about-us pantalla-card">
			<div class="flexslider-top--about">
		    	...
		    	<div class="redes-sociales">
					<?php
						while (have_rows('redes-sociales', 'option')):
							the_row();
		...
		<div class="pantalla-promos pantalla-card">
			...
			<div class="contenedor-pantalla">
				...
				?>
						...
						<!-- Estructura HTML para cada platillo -->
						<div id="<?php echo esc_attr($id); ?>" class="plato js-abrir-plato js-plato-menu js-pantalla-contenida plato--active"
							data-id = "<?php echo esc_attr($id); ?>"
							data-cat="<?php echo esc_attr($categoria); ?>"
							data-titulo="<?php echo esc_attr($titulo); ?>"
							data-precio="<?php echo esc_attr($precioUnitario); ?>"
